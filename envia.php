...
function enviar($recibido, $enviado, $idWA,$timestamp,$telefonoCliente) {
    ...
    if ($cantidad == 0) {
        ...
        $token = 'EAAEzRYunwLsBO5W6AP9ZBRgNcmBZBYvApzFvYzEnCpCq4iP1BJyuVGF5gjZBNh6Nw12qhtC4xSI2nXVyXO4bOE4EIlj6XloecRlZBffnwuXtGqWsmNCx49FdV1pbEFVPVD91nh5iT86bo1VZCRZA6g3wo7SmojChF8dg2jYPCEX9GUS2grR1MyZBilJ2lhHR0KA';
        //NUESTRO TELEFONO
        //$telefonoCliente=str_replace("521","52",$telefonoCliente);
        $telefonoCliente='59179803692';
        //IDENTIFICADOR DE NÚMERO DE TELÉFONO
        $telefonoID = '192427640609531';
